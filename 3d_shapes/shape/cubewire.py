...
class CubeWire(MeshWire):
    def __init__(self, 
                 shader: Shader, 
                 vertexFile: str, 
                 model: glm.mat4 = glm.mat4(1.0),
                 color: glm.vec3 = glm.vec3(0.2, 0.8, 0.4)):
        """
        Create a wireframe cube from a vertex file
        ...
        # Define cube edges 
        # This assumes vertices are in a specific order (cube corners)
        edges = [
            # Bottom square
            (0, 1), (1, 2), (2, 3), (3, 0),
            # Top square
